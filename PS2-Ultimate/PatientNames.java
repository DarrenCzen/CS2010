...
//                                  Eldon Ng, Help me realise that i needed to take care of the null cases when deletion happens for my methods like balance factor
...
class PatientNames {
    ...
    void RemovePatient(String patientName) {
        maleList.delete(patientName);
        femaleList.delete(patientName);
    }
    ...
    int Query(String START, String END, int gender) {
        ...
        if (gender == 0 || gender == 1) {
            ...
            ans += maleList.rank(END) - maleList.rank(START);
        }

        if (gender == 0 || gender == 2) {
            ans += femaleList.rank(END) - femaleList.rank(START);
        }
...
class BST {
    ...
    public int rank(BSTVertex T, String v) {
        ...
        // apple is  lexicographically larger than app
        // zzz is lexicographically larger than apple
        // apple.compareTo(bob) will return a negative value
    ...
    public BSTVertex rotateTree(BSTVertex T, int bF) {
        // 4 Cases
        if(bF == 2){
